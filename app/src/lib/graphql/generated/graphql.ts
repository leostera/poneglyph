...
export type DetectLocalPlexConnectionQuery = { __typename?: 'Query', detectLocalPlexConnection: { __typename?: 'PlexDetection', baseUrl: string, token?: string | null, machineIdentifier?: string | null, libraries: Array<string> } };
