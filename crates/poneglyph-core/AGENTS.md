...
- `poneglyph-core` is the main backend library crate.
- Keep domain types, stores, services, consolidation, projections, schema/entity management, query, and workspace runtime modular.
- A future `poneglyph-db` crate may extract storage/Datafox-specific implementation when that boundary is clearer.
